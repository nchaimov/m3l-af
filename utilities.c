...
void Print_Banner(FILE *fp)
{
	...
	PhyML_Fprintf(fp,"                                                                                                  \n");
	PhyML_Fprintf(fp,"                                 ---  PhyML %s +M3L  ---                      \n", VERSION);
	//PhyML_Fprintf(fp,"                                   ---  PhyML %s  ---                                             \n",VERSION);
	PhyML_Fprintf(fp,"                                                                                                  \n");
	PhyML_Fprintf(fp,"    PhyML is a simple, fast, and accurate algorithm to estimate large phylogenies by maximum likelihood    \n");
	PhyML_Fprintf(fp,"\n");
	PhyML_Fprintf(fp,"                            Stephane Guindon & Olivier Gascuel                                      \n");
	//PhyML_Fprintf(fp,"                                                                                                  \n");
	PhyML_Fprintf(fp,"                           http://www.atgc-montpellier.fr/phyml                                   \n");
	PhyML_Fprintf(fp,"                                                                                                  \n");
	PhyML_Fprintf(fp,"    +M3L is a modification of the PhyML source code to accommodate multiple branch-length ratios, \n");
	PhyML_Fprintf(fp,"       and to estimate statistical support for clades as posterior probabiity values\n");
