...
typedef struct __Node {
  ...
  m3ldbl                              **l; /* JSJ: lengths of the (three or one) branch length sets connected this node */
...
(left_2) .                   .(right_2)
  ...
  */
  ...
  m3ldbl                               *l; /* JSJ: branch lengths */
  m3ldbl                          *best_l; /* JSJ: best branch lengths found so far */
  m3ldbl                           *l_old; /* JSJ: old branch lengths */
