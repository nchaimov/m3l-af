...
am_phyml_OBJECTS = main.$(OBJEXT) utilities.$(OBJEXT) \
	optimiz.$(OBJEXT) lk.$(OBJEXT) bionj.$(OBJEXT) \
	models.$(OBJEXT) free.$(OBJEXT) options.$(OBJEXT) \
	simu.$(OBJEXT) eigen.$(OBJEXT) pars.$(OBJEXT) alrt.$(OBJEXT) \
	interface.$(OBJEXT) cl.$(OBJEXT) spr.$(OBJEXT) draw.$(OBJEXT) \
	mpi_boot.$(OBJEXT) numeric.$(OBJEXT)
phyml_OBJECTS = $(am_phyml_OBJECTS)
phyml_DEPENDENCIES = main.o utilities.o optimiz.o lk.o bionj.o \
	models.o free.o options.o simu.o eigen.o pars.o alrt.o \
	interface.o cl.o spr.o draw.o mpi_boot.o numeric.o
DEFAULT_INCLUDES = -I.
...
STRIP = 
VERSION = v3.0 (179M)
abs_builddir = /Users/jstjohn/Documents/workspace/phyml
abs_srcdir = /Users/jstjohn/Documents/workspace/phyml
abs_top_builddir = /Users/jstjohn/Documents/workspace/phyml
abs_top_srcdir = /Users/jstjohn/Documents/workspace/phyml
ac_ct_CC = gcc
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
...
install_sh = $(SHELL) /Users/jstjohn/Documents/workspace/phyml/install-sh
...
top_builddir = .
top_srcdir = .
#AM_CFLAGS = -g -O3 -fomit-frame-pointer -funroll-loops -Wall 
AM_CFLAGS= -g -pg -Wall
AM_LDFLAGS = -lm
PROG = PHYML
phyml_SOURCES = main.c utilities.c optimiz.c lk.c bionj.c models.c free.c\
options.c simu.c eigen.c pars.c alrt.c interface.c cl.c spr.c  draw.c mpi_boot.c numeric.c

phyml_LDADD = main.o utilities.o optimiz.o lk.o bionj.o models.o free.o\
options.o simu.o eigen.o pars.o alrt.o interface.o cl.o spr.o draw.o mpi_boot.o numeric.o
